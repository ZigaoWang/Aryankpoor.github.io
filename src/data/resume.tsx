  ...
  work: [
    {
      ...
      description:
        "Helped organizations get onboarded to Hack Club Bank and help them with their financial needs. Also built automations to automate the workflow for new Hack Club teen applications. ",
    },
    {
      company: "Hack Club",
      badges: [],
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "A SaaS web application which allows users to create and send invoices from within the website with built-in email interface and manage their business with added payment capabilities.",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
    ...
    },
    {
      ...
      active: true,
      description:
        "A lightweight desktop screen recorder developed in electron.",
      technologies: [
        "Electron",
        "Desktop",
      ],
    ...
    },
    {
      ...
      active: true,
      description:
        "The static version and the project that originallyyy inspired me to make Metamorpheus.",
      technologies: [
        "Appwrite",
        "OpenAI API",
        "Javascript",
      ...
      links: [
        {
          type: "Website",
          href: "https://66fae161a2e8bd509a99.appwrite.global/",
          icon: <Icons.globe className="size-3" />,
        },
        {
          type: "Source",
          href: "https://github.com/Aryankpoor/gpt-bot",
          icon: <Icons.github className="size-3" />,
        }
      ],
      image: "",
